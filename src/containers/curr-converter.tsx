...
import { CurrencySelect } from './curr-select';
import { CurrencyInput } from './curr-input';
      ...
      <div className="o-grid o-grid--xsmall-full o-grid--small-full o-grid--medium-full">
        ...
        <div className="o-grid__cell u-window-box--medium">
          ...
          />
            ...
            <a href="/info" className="o-grid__cell u-window-box--medium" target="_blank">Disclaimer</a>
